...
//Slave IP:
$GLOBALS['CULTIPI']['USE_REMOTE_SLAVE'] = 0; // Can be 0 or 1
$GLOBALS['CULTIPI']['REMOTE_NB_SLAVE'] = 5;
$GLOBALS['CULTIPI']['REMOTE_SLAVE'] = array ( 
...
// Remote sensors
$GLOBALS['CULTIPI']['USE_REMOTE_SENSOR'] = 0; // Can be 0 or 1
$GLOBALS['CULTIPI']['REMOTE_SENSOR'][] = array ( 
...
// Direct read
$GLOBALS['CULTIPI']['USE_DIRECT_READ'] = 0; // Can be 0 or 1
// Type can be SHT DS18B20 WATER_LEVEL PH EC OD ORP
$GLOBALS['CULTIPI']['DIRECT_SENSOR'][] = array ( 
    "SENSOR_INDEX" => 1,
    "SENSOR_FIRST_INPUT" => 1,
    "SENSOR_FIRST_VALUE" => 1,
    "SENSOR_SECOND_INPUT" => 2,
    "SENSOR_SECOND_VALUE" => 2,
    "SENSOR_FIRST_STATUS_OK" => 1,
    "SENSOR_SECOND_STATUS_OK" => 1,
